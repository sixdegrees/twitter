    ...
    context ".new(:format => '#{format}')" do
      ...
      describe ".user" do
        ...
        context "with screen name passed" do
            ...
            before do
              stub_get("1.1/users/show.#{format}").
      ...
      describe ".users" do
        ...
        context "with screen names passed" do
          ...
          before do
            stub_get("1.1/users/lookup.#{format}").
      ...
      describe ".user_search" do
        ...
        before do
          stub_get("1.1/users/search.#{format}").
      ...
      describe ".suggestions" do
        ...
        context "with a category slug passed" do
          ...
          before do
            stub_get("1.1/users/suggestions/art-design.#{format}").
          ...
          it "should get the correct resource" do
            ...
            a_get("1.1/users/suggestions/art-design.#{format}").
              should have_been_made
          end
      ...
      describe ".suggest_users" do
        ...
        before do
          stub_get("1.1/users/suggestions/art-design/members.#{format}").
        ...
        it "should get the correct resource" do
          ...
          a_get("1.1/users/suggestions/art-design/members.#{format}").
            should have_been_made
        end
      ...
      describe ".profile_image" do
        ...
        context "with screen name passed" do
          ...
          before do
            stub_get("1.1/users/profile_image/sferik.json").
          ...
          it "should redirect to the correct resource" do
            ...
            a_get("1.1/users/profile_image/sferik.json").
              with(:status => 302).
              should have_been_made
      ...
      describe ".friends" do
        ...
        context "with a screen name passed" do
          ...
          before do
            stub_get("1.1/statuses/friends.#{format}").
          ...
          it "should get the correct resource" do
            ...
            a_get("1.1/statuses/friends.#{format}").
              with(:query => {:screen_name => "sferik", :cursor => "-1"}).
              should have_been_made
          end
      ...
      describe ".followers" do
        ...
        context "with a screen name passed" do
          ...
          before do
            stub_get("1.1/statuses/followers.#{format}").
              with(:query => {:screen_name => "sferik", :cursor => "-1"}).
          ...
          it "should get the correct resource" do
            ...
            a_get("1.1/statuses/followers.#{format}").
              with(:query => {:screen_name => "sferik", :cursor => "-1"}).
              should have_been_made
          end
      ...
      describe ".contributees" do
        ...
        context "with a screen name passed" do
          ...
          before do
            stub_get("1.1/users/contributees.#{format}").
              with(:query => {:screen_name => "sferik"}).
          ...
          it "should get the correct resource" do
            ...
            a_get("1.1/users/contributees.#{format}").
              with(:query => {:screen_name => "sferik"}).
              should have_been_made
          end
      ...
      describe ".contributors" do
        ...
        context "with a screen name passed" do
          ...
          before do
            stub_get("1.1/users/contributors.#{format}").
              with(:query => {:screen_name => "sferik"}).
          ...
          it "should get the correct resource" do
            ...
            a_get("1.1/users/contributors.#{format}").
              with(:query => {:screen_name => "sferik"}).
              should have_been_made
          end
